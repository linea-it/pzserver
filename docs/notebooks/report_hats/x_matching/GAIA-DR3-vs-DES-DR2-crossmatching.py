...
hats_first_catalog_name = 'gaia_dr3_hats'
hats_first_margin_cache = None

hats_first_name_for_output = 'gaia_dr3_hats'
...
if save_the_dask_jobs_info or save_the_info:
    user = getpass.getuser()
    user_base_path = f'/lustre/t0/scratch/users/{user}/report_hats/GAIA-DR3-vs-DES-DR2'
