...
############################################################ PATHS ############################################################
hats_input_catalog = '/lustre/t1/cl/lsst/pz_project/test_data/2mass_hats'
hats_input_catalog_ra = 'ra'
hats_input_catalog_dec = 'decl'

if run_the_pipeline==True:
    hats_margin_cache_path = '/lustre/t1/cl/lsst/pz_project/test_data'
    hats_margin_cache_name = f'2mass_margin_cache'

if save_the_dask_jobs_info or save_the_info:
    user = getpass.getuser()
    user_base_path = f'/lustre/t0/scratch/users/{user}/report_hats/2MASS-margin-cache'
